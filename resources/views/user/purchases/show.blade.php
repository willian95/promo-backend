        ...
        <div class="info-detail" style="margin-top: 50px;">
            ...
            <div class="view-detail">
                ...
                <div v-if="authCheck == true">
                    ...
                    <h5 v-if="paymentsAmount >= 2 && paymentsAproved >= 1 && paymentsWaiting == 1 || paymentsWaiting > 1">Ya ha realizado los pagos respectivos, espere la confirmación de los mismos</h5>
                    <div v-else>
