    ...
    <div class="container pt-150 " id="dev-area">
        ...
        <div class="row cont-publicacion-form-info">
            ...
            <div class="col-md-6">
                ...
                <p><small v-if="type == 1">Se añadirá un 0,5% de comisión</small></p>

                <small v-if="type == 2">Puedes publicar 5 promociones</small>
                <p><small v-if="type == 2">Se añadirá un 0,6% de comisión</small></p>

                <small v-if="type == 3">Puedes publicar 8 promociones</small>
                <p><small v-if="type == 3">Se añadirá un 0,7% de comisión</small></p>
            </div>
            <div class="col-md-12">
                <div class="form-group">
