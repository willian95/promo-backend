                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;font-size:0px;"><img class="adapt-img" src="https://servertest.sytes.net/comilandia/public/user/images/logo.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;object-fit: contain;" width="200" height="133"></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
              ...
              <td align="left" style="Margin:0;padding-bottom:15px;padding-top:30px;padding-left:30px;padding-right:30px;border-radius:10px 10px 0px 0px;background-color:#FFFFFF;" bgcolor="#ffffff">
                ...
                @foreach($purchaseProducts as $purchase)
                  ...
                  <tr style="border: 1px solid black; border-collapse:collapse">
                      ...
                      <td style="border: 1px solid black; border-collapse:collapse; text-align:center">{{ $purchase->postProduct->title }}</td>
                      <td style="border: 1px solid black; border-collapse:collapse; text-align:center">{{ $purchase->amount }}</td>
                      <td style="border: 1px solid black; border-collapse:collapse;text-align:center ">$ {{ $purchase->price }}</td>
                      <td style="border: 1px solid black; border-collapse:collapse; text-align:center">$ {{ $purchase->price * $purchase->amount }}</td>
